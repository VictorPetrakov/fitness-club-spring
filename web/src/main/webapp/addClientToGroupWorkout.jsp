...
<div id="page">
    ...
    <div id="colorlib-subscribe1" class="subs-img" style="white-space: normal;" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
            <div class="row">
                <form action="addClientToWorkoutGroup" method="post">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
                                <h2>Добавте клиента на Вашу групповую тренировку</h2>
                                <p>Введите данные</p>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="loginClient"
                                                   placeholder="Введите логин клиента">
                                        </div>
                                        <div class="form-group">
                                            <select name="nameGroup" class="form-control">
                                    ...
                                    <div class="col-md-12">
                                        <form class="form-inline qbstp-header-subscribe">
                                            ...
                                            <div class="col-one-third">
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-primary">Subscribe Now
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
                    ...
                    <div class="container">
                        <div class="row row-pb-md">
                            ...
                            <div class="col-md-3 colorlib-widget">
                                <h4>Recent Post</h4>
                                <div class="f-blog">
                                    <a href="blog.jsp" class="blog-img"
                            ...
                            <div class="col-md-3 colorlib-widget">
                                ...
                                <ul class="colorlib-footer-links">
                                    ...
                                    <li><a href="tel://1234567920"><i class="icon-phone"></i> + 1235 2355 98</a>
                                    </li>
                                    <li><a href="mailto:info@yoursite.com"><i class="icon-envelope"></i>
                                        info@yoursite.com</a></li>
                                    <li><a href="http://luxehotel.com"><i class="icon-location4"></i>
                                        yourwebsite.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <p>
                                        <small class="block">&copy;
                                            ...
                                            All rights reserved | This template is made with <i class="icon-heart"
                                                                                                aria-hidden="true"></i>
                                            by <a target="_blank">VictorPetrakov</a>
                                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                        </small><br>
