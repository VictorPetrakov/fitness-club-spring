					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
								<div class="slider-text-inner text-center">
									<h1>Потенциал чемпиона в каждом из нас!</h1>
									<p><a href="#" class="btn btn-primary btn-lg btn-learn">Join Classes</a></p>
								</div>
							</div>
						</div>
				...
				<li style="background-image: url(images/img_bg_3.jpg);">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
								<div class="slider-text-inner text-center">
									<h1>Хватит мечтать, пора действовать!</h1>
									<p><a href="#" class="btn btn-primary btn-lg btn-learn">Join Classes</a></p>
								</div>
							</div>
						</div>
				...
				<li style="background-image: url(images/img_bg_4.jpg);">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
								<div class="slider-text-inner text-center">
									<h1>Возможность преодолеть себя — без сомнений, самое ценное свойство спорта</h1>
									<p><a href="#" class="btn btn-primary btn-lg btn-learn">Join Classes</a></p>
								</div>
							</div>
						</div>
				...
				<div class="col-md-12 intro-wrap animate-box">
					<div class="intro-flex">
						<div class="one-third intro-img" style="background-image: url(images/intro-img-1.jpg)">
							<div class="desc">
								<h3>Бодибилдинг</h3>
								<p>Твое тело - </br> отражение твоего образа жизни</br></br></br></p>
								<span class="price text-center">$25.00<br><small>/в месяц</small></span>
							</div>
						</div>
						<div class="one-third intro-img" style="background-image: url(images/intro-img-2.jpg)">
							<div class="desc">
								<h3>Йога</h3>
								<p>Тело — ваш храм. </br>Держите его чистым, чтобы душа жила.</br></br></br></p>
								<span class="price text-center">$25.00<br><small>/в месяц</small></span>
							</div>
						</div>
						<div class="one-third intro-img" style="background-image: url(images/intro-img-3.jpg)">
							<div class="desc">
								<h3>Стэп-аэробика</h3>
								<p>Степ аэробика – это быстрый и эффективный способ скинуть лишние килограммы с максимальным удовольствием.</p>
								<span class="price text-center">$25.00<br><small>/в месяц</small></span>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
					<h2>Начни меняться с нами!</h2>
					<p>Наша комманда, квалифицированных трениров, помежет тебе в достижении твоих целей.</p>
				</div>
			</div>
			<div class="row">
