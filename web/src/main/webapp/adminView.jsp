        ...
        <div class="container">
            <div class="row">
                <div class="desc">
                    ...
                    <h2>Администраторы фитнесс клуба</h2>
                    <table>
                        <tr>
                            <th>id &ensp;</th>
                            <th>login &ensp;</th>
                        ...
                        <c:forEach items="${requestScope.admin}" var="admin">
                            ...
                            <tr>
                                <td><c:out value="${admin.id}" default="----"/></td>
                                <td><c:out value="${admin.login}" default="----"/></td>
                                <td><c:out value="${admin.password}" default="----"/></td>
                                <td><c:out value="${admin.firstName}" default="----"/></td>
                                <td><c:out value="${admin.lastName}" default="----"/></td>
                                <td><c:out value="${admin.birthdate}" default="----"/></td>
                                <td><c:out value="${admin.email}" default="----"/></td>
                            </tr>
                        </c:forEach>
                    </table>
                </div>
