...
@WebFilter(filterName = "AuthFilter", urlPatterns = "/contact.html", initParams = {@WebInitParam(name = AuthenticationFilter.IS_ACTIVE_FILTER_PARAM, value = "true", description = "activation of this filter")})
